...
Reduced reproduction: one significant comparison on four instances, meant to be runnable in a few minutes from a fresh build directory.

## Comando

```bash
python3 tools/benchmark/run.py configs/suites/smoke.json --cpu <core>
```
...
- run previsti: 16
- run memorizzati: 16
- verificati da una chiamata `pclp verify` separata: 16
- stati: optimal 16
